...
df.MEI_ExchangeRates <- data.frame(read.csv("data/MultipleCountries/currency_multiple.csv", header=TRUE, sep=",", dec=","))
df.MEI_Multiple <- data.frame(read.csv("data/MultipleCountries/m1_m3_irlt_irst_shares_interbank_exchangerates.csv", header=TRUE, sep=",", dec=","))
